...
<h3 id="javascript包含几种数据类型-分别是-判断数据类型的方法" tabindex="-1"><a class="header-anchor" href="#javascript包含几种数据类型-分别是-判断数据类型的方法" aria-hidden="true">#</a> JavaScript包含几种数据类型，分别是？判断数据类型的方法？</h3>
<p>undefined、null、布尔值（Boolean）、字符串（String）、数值（Number）、大整数（BigInt）、对象（Object）、Symbol。</p>
<h3 id="javascript常用的数组方法" tabindex="-1"><a class="header-anchor" href="#javascript常用的数组方法" aria-hidden="true">#</a> JavaScript常用的数组方法</h3>
<h4 id="改变原数组" tabindex="-1"><a class="header-anchor" href="#改变原数组" aria-hidden="true">#</a> 改变原数组</h4>
<p>push()、unshift()、pop()、shift()、reverse()、sort()、</p>
<h4 id="不改变原数组" tabindex="-1"><a class="header-anchor" href="#不改变原数组" aria-hidden="true">#</a> 不改变原数组</h4>
<p>concat()、join()、slice()、flat()、filter()、some()、</p>
<h3 id="javascript常用的字符串方法" tabindex="-1"><a class="header-anchor" href="#javascript常用的字符串方法" aria-hidden="true">#</a> JavaScript常用的字符串方法</h3>
